...
import mail
def checktick():
	filename='C:/Users/Administrator/AppData/Roaming/MetaQuotes/Terminal/6A8058911C98E1D14B8F4592B28ED9C5/MQL4/Files/tick.csv'
...
def loadcsv_add():
	...
	date_=[]
	time_=[]
	filename='C:/Users/Administrator/AppData/Roaming/MetaQuotes/Terminal/6A8058911C98E1D14B8F4592B28ED9C5/MQL4/Files/price_record.csv'
	sql=""
	try:
	...
	filenode.close()
	#决策函数
	decision(name_,close,0.9,0.0007)
	print(len(date_))
	for i in range(len(date_)):
				
		sql=sql+"insert into stock_lmx.stock values ('"+name_[i]+"','"+date_[i]+"','"+time_[i]+"','"+open_[i]+"',0,0,'"+close[i]+"',0,0,null);"
...
def loadcsv_add_clear():
	...
	# file_object.write("")
	# file_object.close()
	os.remove('C:/Users/Administrator/AppData/Roaming/MetaQuotes/Terminal/6A8058911C98E1D14B8F4592B28ED9C5/MQL4/Files/price_record.csv')
...
def write_API(stockid,lnA_B_now,lnA_B_except,orderid):
	file_object = open("C:/Users/Administrator/AppData/Roaming/MetaQuotes/Terminal/6A8058911C98E1D14B8F4592B28ED9C5/MQL4/Files/create.txt",'w')
	json=""
...
if __name__ == "__main__":
	...
	while(1):
		if (os.path.exists("C:/Users/Administrator/AppData/Roaming/MetaQuotes/Terminal/6A8058911C98E1D14B8F4592B28ED9C5/MQL4/Files/price_record.csv")):
